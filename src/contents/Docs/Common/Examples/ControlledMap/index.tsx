  ...
  return (
    <View className="relative h-full w-full">
      <Map
        ...
        style={{ flex: 1 }}
      />
      <View className="border-border bg-background/80 absolute top-2 left-2 z-10 max-w-64 flex-row flex-wrap gap-x-2 gap-y-0.5 rounded border px-2 py-1.5 backdrop-blur">
